    ...
    <div class="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
      <div class="relative mx-auto max-w-7xl px-32 sm:static sm:px-32 lg:px-8">
        ...
        <br>
          ...
          <br>
       <p class="mt-4 text-xl text-gray-900 text-">"En este blog personal de programación web, encontrarás información valiosa sobre el desarrollo de sitios web y aplicaciones en línea. Desde consejos y trucos para mejorar la eficiencia de tu código, hasta tutoriales detallados sobre el uso de las últimas tecnologías y herramientas del mercado."</p>
      <br>
